...
public interface AssemblingScreenCoords {
    ...
    float BLOCK_SIZE = Math.min(Math.min((float) (SCREEN_HEIGHT / (FIELD_HEIGHT + 2)), (float) (SCREEN_WIDTH / (FIELD_WIDTH + 4))), (float) (SCREEN_HEIGHT / (NUMBER_OF_ITEMS + 2)));  // Размер одного блока
